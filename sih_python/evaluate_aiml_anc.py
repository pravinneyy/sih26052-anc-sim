...
def benchmark(args):
    ...
    print("  - Tighter Huber beta (2.0x vs 3.0x) prevents filter contamination")
    print("  - 0.40x mu recovery (vs 0.15x for System C) - 3x faster post-blast")
    print("  - 1.15x mu in normal state - 15% efficiency gain in stationary noise")
